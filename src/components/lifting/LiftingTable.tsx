  ...
  renderCell = (entry: Entry, columnType: ColumnType, categoryResults: Array<CategoryResults>): JSX.Element => {
    switch (columnType) {
      ...
      case "ProjectedTotal": {
        ...
        entry.points = totalKg === 0 ? null : parseInt(displayWeight(asNumber, this.props.language));
      ...
      case "ProjectedPoints": {
        ...
        if (this.props.meet.formula === "Total") {
          entry.points = points !== 0 ? parseInt(displayWeight(points, this.props.language)) : null;
          return <td key={columnType}>{points !== 0 ? displayWeight(points, this.props.language) : null}</td>;
        }
        entry.points = points !== 0 ? parseInt(displayPoints(points, this.props.language)) : null;
